...
def write_delta(in_alns, in_file_name, f1, f2):
...
parser.add_argument("--ref_fa", type=str, help="absolute path to reference fasta file", default="file1")
parser.add_argument("--qry_fa", type=str, help="absolute path to query fasta file", default="file2")
...
write_delta(alns, sam_file + '.delta', refFa, qryFa)
