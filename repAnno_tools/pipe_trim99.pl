...
&exeCmd("cat woNest.fullLTR.examplars notMasked.full_LTR.fa.examplars | perl $tool{pl_deal_fasta} -frag_head -frag_width 80 -frag 0-0 | perl $tool{pl_deal_fasta} -chopKey \':\\d+\-\\d+\$' > TRIM99.lib"); 
