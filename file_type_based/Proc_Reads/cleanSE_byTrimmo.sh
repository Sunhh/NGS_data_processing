...
para_SE="ILLUMINACLIP:$adp_fas:2:30:10   SLIDINGWINDOW:4:20 LEADING:3 TRAILING:3 MINLEN:$minLen"
adp_fas="/data/Sunhh/src/Assemble/Trimmomatic/Trimmomatic-0.32/adapters/TruSeq3-SE.fa"
...
do
	...
	para_jarAdd=""
	cmd="$exe_java -jar $exe_jar SE $para_jar $para_jarAdd $inFq1 $inFq2 ${oPref}_pTr_R1.fq ${oPref}_sTr_R1.fq ${oPref}_pTr_R2.fq ${oPref}_sTr_R2.fq $para_SE"
	exe_cmd "$cmd"
done
