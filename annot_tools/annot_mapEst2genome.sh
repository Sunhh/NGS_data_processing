...
### Basic settings
# First you need to add spaln_path to $PATH
...
### Personal files. 
inFileLis="qryEstFasLis"
dbID=PG1All_v2
outFmtGff=all_spaln2genom_est_wiM4.fmt.gff3
...
then
	...
	echo "Try $path2Me qryEstFasLis spaln_dbID"
	echo ""
	echo "########################################################"
	exit 1; 
fi
...
do
	...
	exe_cmd "perl $pl_cnvt2maker ${qryFa}.spaln.gff3 | perl -pe ' s!\tprotein_match\t!\tmatch\t!; ' > ${qryFa}.med.gff3"
