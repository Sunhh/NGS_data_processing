...
my @suff_arr; 
if ($pTag eq 'P1') {
	push( @suff_arr, ["P1g_allMisR0p06", "_toP1.allMisR0p06.sense.cnt"] ) ; 
	push( @suff_arr, ["P1g_P1spec",      "_toP1.specMisR0p01_inP1.sense.cnt"] ) ; 
	push( @suff_arr, ["P1g_P3spec",      "_toP3.specMisR0p01_inP1.sense.cnt"] ) ; 
	push( @suff_arr, ["P1g_cmmn",        "_toP1.cmmnMisR0p06_inP1.sense.cnt"] ) ; 
	# Combine subsets. 
	#  "P1g_total", 'P1g_P1spec' + 'P1g_P3spec' + 'P1g_cmmn'
} elsif ($pTag eq 'P3') {
	push( @suff_arr, ["P3g_allMisR0p06", "_toP3.allMisR0p06.sense.cnt"] ) ; 
	push( @suff_arr, ["P3g_P1spec",      "_toP1.specMisR0p01_inP3.sense.cnt"] ) ; 
	push( @suff_arr, ["P3g_P3spec",      "_toP3.specMisR0p01_inP3.sense.cnt"] ) ; 
	push( @suff_arr, ["P3g_cmmn",        "_toP3.cmmnMisR0p06_inP3.sense.cnt"] ) ; 
