...
## Plot alignments in a HS-format PAF file.
- Required columns in `g1_to_g2-aln-fmt.paf`: QID  QLen  QS  QE  Str  SID  SLen  SS  SE  Match  BlkLen  MapQ  QIdent  SIdent  Ident  PrimaryTag;
- Required R packages: `data.table`, `ggplot2`, `grid`
```sh
minimap2 -x asm5 -t60 g2.chr.fa g1.chr.fa | perl ~/fmt_paf.pl > g1_to_g2-aln-fmt.paf;
Rscript plot_paf_fmt.r  --input g1_to_g2-aln-fmt.paf  --prefix g1_to_g2  --xlab g1  --ylab g2 [--preset screen --show-axis-coord true --coord-step 10Mb];
Rscript plot_paf_fmt.r  --input g1_to_g2-aln-fmt.paf  --prefix g1_to_g2  --xlab g1  --ylab g2 --x-seqs chr03,chr02,chr05 --y-seqs 2,5,4;
```
